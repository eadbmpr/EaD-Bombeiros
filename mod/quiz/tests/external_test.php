...
class mod_quiz_external_testcase extends externallib_advanced_testcase {
    ...
    public function test_get_access_information() {
        ...
        $result = mod_quiz_external::get_access_information($quiz->id);
        $result = external_api::clean_returnvalue(mod_quiz_external::get_access_information_returns(), $result);
        ...
        $this->assertCount(0, $result['preventnewattemptreasons']);

        // Back to quiz open but with limited attempts.
        ...
        $result = mod_quiz_external::get_access_information($quiz->id, $attempt->id);
        $result = external_api::clean_returnvalue(mod_quiz_external::get_access_information_returns(), $result);
    ...
    public function test_validate_attempt() {
        ...
        try {
            ...
            $this->assertEquals('invalidpagenumber', $e->errorcode);
        }
    ...
    public function test_get_attempt_data() {
        ...
        $this->assertEquals('Pi to two d.p.', $result['questions'][0]['name']);
        $this->assertEquals('qtype_numerical', $result['questions'][0]['type']);
    ...
    public function test_view_attempt() {
        ...
        try {
            ...
            $this->assertEquals('outofsequenceaccess', $e->errorcode);
        }
